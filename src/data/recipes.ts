 ...
 * Fender, Ornament, Dial Design, Steering Wheel, Hydraulic Kit, Plaque, Stage 2 Valves, remaining kits.
 */
...
export const CATALOG_RECIPES: Recipe[] = [
  ...
  {
    id: 'rec-race-automatic-gearbox',
    name: 'Race Automatic Gearbox',
    category: 'parts',
    salePrice: 0,
    ingredients: [
      { materialId: 'mat-steel-plate', qty: 45 },
      { materialId: 'mat-scrap-metal', qty: 12 },
      { materialId: 'mat-lightweight-metal', qty: 5 },
      { materialId: 'mat-circuit-bundle', qty: 2 },
    ],
  },
  {
    id: 'rec-semi-dct-gearbox',
    name: 'Semi DCT Gearbox',
    category: 'parts',
    salePrice: 0,
    ingredients: [
      { materialId: 'mat-steel-plate', qty: 50 },
  ...
  },
  {
    ...
    ingredients: [
      { materialId: 'mat-steel-plate', qty: 40 },
      { materialId: 'mat-scrap-metal', qty: 50 },
      { materialId: 'mat-scrap-tin', qty: 30 },
      { materialId: 'mat-broken-carparts', qty: 22 },
      { materialId: 'mat-polymer-strip', qty: 30 },
      { materialId: 'mat-circuit-bundle', qty: 50 },
      { materialId: 'mat-lightweight-metal', qty: 14 },
  ...
  {
    id: 'rec-stage-2-crankshaft',
    name: 'Stage 2 Crankshaft',
    category: 'engines',
    salePrice: 0,
    ingredients: [
      { materialId: 'mat-steel-plate', qty: 33 },
...
export const CATALOG_PRODUCTS: Product[] = [
  ...
  {
    id: 'prod-race-automatic-gearbox',
    name: 'Race Automatic Gearbox',
    category: 'parts',
    cost: 0,
    salePrice: 0,
    stock: 0,
    recipeId: 'rec-race-automatic-gearbox',
  },
  {
    id: 'prod-semi-dct-gearbox',
    name: 'Semi DCT Gearbox',
    category: 'parts',
    cost: 0,
    salePrice: 0,
    stock: 0,
    recipeId: 'rec-semi-dct-gearbox',
  },
  {
    id: 'prod-35mm-turbo',
    name: '35mm Turbo',
  ...
  {
    id: 'prod-stage-2-crankshaft',
    name: 'Stage 2 Crankshaft',
    category: 'engines',
    cost: 0,
    salePrice: 0,
    stock: 0,
    recipeId: 'rec-stage-2-crankshaft',
  },
  {
    id: 'prod-stage-1-valves',
    name: 'Stage 1 Valves',
    category: 'engines',
    cost: 0,
    salePrice: 0,
    stock: 0,
    recipeId: 'rec-stage-1-valves',
  },
]
